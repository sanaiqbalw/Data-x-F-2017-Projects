/* [matchings] = matchingpointsinC(Data1,Data2)
   This function finds for each row in Data1 the closest match in Data2 using squared Euclidean distances. 
   ...
   Outputs: matchings is a column vector with the same number of rows as Data1 with row indices indicating the best match in Data2.
   by
