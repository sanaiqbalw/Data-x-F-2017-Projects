...
title('potentialMap * spline mask');
%% 
...
img = load(['D:\Google Drive\Berkeley\Courses\Data X IEOR 290\Project\Cartilage-X\PreProcessing Resources\manualExamplesforKosta\mri_', num2str(man_image_num), '.mat']);
