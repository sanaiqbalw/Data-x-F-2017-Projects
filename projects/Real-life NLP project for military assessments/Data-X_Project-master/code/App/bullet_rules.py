...
#read csv file with character sizes for Times 12pt font
chardict = csv2dict('resources/CharSizes.csv')
#covert the numbers to floats
for key in chardict:
    chardict[key] = float(chardict[key])